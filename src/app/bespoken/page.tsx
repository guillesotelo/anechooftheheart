    ...
    const renderStory = () => {
        return (
            <div className="bespoken__container">
                ...
                <div className="page__header"><p className="bespoken__product-goback" onClick={() => router.push('/')}>↩ {TEXT[lang].anechooftheheart}</p>
            ...
            <div className="bespoken__container">
                <div className="page__header">
                    {products ?
                        ...
                        : <p className="bespoken__product-goback" onClick={() => router.push('/')}>↩ {TEXT[lang].anechooftheheart}</p>
                    }
                    <h1
